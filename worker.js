...
const fileQueue = async.queue(async ({ path, user }, callback) => {
  ...
  let SIDS = [
    'SID:S-1-5-21-2042961196-1878016268-396375212-407955',
    'SID:S-1-5-21-2042961196-1878016268-396375212-407877',
    'SID:S-1-5-21-2042961196-1878016268-396375212-475325',
    'SID:S-1-5-21-2042961196-1878016268-396375212-407802',
    'SID:S-1-5-21-2042961196-1878016268-396375212-407708',
    'SID:S-1-5-21-2042961196-1878016268-396375212-570187',
    'SID:S-1-5-21-2042961196-1878016268-396375212-407705',
    'SID:S-1-5-21-502124615-1663736127-3055174920-1106'
  ];
  ...
  for (acl of response.acl) {
    if (SIDS.contains(acl.trustee.id)) {
      ...
      response.owner.name = 'root'
      response.owner.id = 'UID:0'
    }
